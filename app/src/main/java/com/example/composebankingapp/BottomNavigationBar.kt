...
import com.example.composebankingapp.data.BottomNavigationItem

val items = listOf<BottomNavigationItem>(
    BottomNavigationItem(title="Home", icon =Icons.Rounded.Home),
    BottomNavigationItem(title="Wallet", icon =Icons.Rounded.Wallet),
    BottomNavigationItem(title="Notifications", icon =Icons.Rounded.Notifications),
    BottomNavigationItem(title="Account", icon =Icons.Rounded.AccountCircle),
)
@Preview
@Composable
